...
<head>
    <meta charset="utf-8">
    <title>Multiplying Game Level 8</title>
...
<body>
    <h1 class="gametitle">Multiplying Number Game &nbsp;<span id="level">Level 8</span><br><br>You need 10 correct answers to proceed to the next level.</h1>

    <!-- Victory Screen -->
    <div class="victory-screen">
        <h1>Level 8  Completed!</h1>
        <br>
        <div class="score">Score : 17</div>
        <div class="buttons">
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <input type="hidden" name="score" value="10"> <!-- Track score -->
	</form>
    <script>
        var playing = false;
        var timeRemaining;
        ...
        function setTimeForLevel(level) {
            timeRemaining = 40;  // Fixed time for level 1
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("Multiplying9.jsp"); // Redirect to the next level
