...
<body>
    ...
    <div class="wrapper">
        <div class="container">
            <center><h2 style="background-color:rgb(99, 188, 230);">Gusses Word Level-9<br></h2></center>
...
word: "eggs",
hint: "what do we eat for breakfast?"
...
word: "juice",
hint: "what do we drink with lunch?"
...
word: "rice",
hint: "what do we eat for dinner?"
   ...
   <%
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("KidGuessLevel10.jsp"); // Redirect to the next level
