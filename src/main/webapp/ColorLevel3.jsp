...
<head>
    ...
    <title>Color Memory Game Lvel3</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <h2>Color Memory Game - Level <span id="level-number">3</span></h2>
        <div class="timer">🕥Time Left: <span id="timer">39</span> seconds</div>
        <div class="game"></div>
    </div>
    ...
    function startTimer() {
        let timeLeft = 39; // Fixed time for level 1
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("ColorLevel4.jsp"); // Redirect to the next level
