...
<head>
    ...
    <title>Emoji Game level 3</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <h2>Emoji Game - Level <span id="level-number">3</span></h2>
        <div class="timer">🕥 Time Left: <span id="timer">36</span> seconds</div>
        <div class="game"></div>
    </div>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <script>
        ...
        function startGame() {
            ...
            gameCompleted = false;
            const numberOfCards = 12;// Fixed number of cards
        ...
        function startTimer() {
            let timeLeft = 36; // Fixed time for the game
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("EmojiLevel4.jsp"); // Redirect to the next level
