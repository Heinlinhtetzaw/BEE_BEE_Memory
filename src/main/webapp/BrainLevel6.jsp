...
<html>
<head>
  <title>Brain Trainer Level6</title>
  <style>
    body {
...
<body>
  <div class="container">
    <h1>Brain Trainer - Level <span id="level-number">6</span></h1>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <input type="hidden" name="score" value="15"> <!-- Track score -->
	</form>
  <script>
...
<%
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("BrainLevel7.jsp"); // Redirect to the next level
