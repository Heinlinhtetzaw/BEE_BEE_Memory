...
<head>
    ...
    <title>Guess a Word Game level-4</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="wrapper">
        <div class="container">
            <center><h2 style="background-color:rgb(28, 223, 70);">Gusses Word Level-4<br></h2></center>
...
word: "dresser",
hint: "what do we put our clothes in?"
...
hint: "what do we store toys in?"
        ...
        function handleVictory() {
            ...
            document.getElementById("victory-level-number").innerText = 4;
        }
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("ToddlerguessLevel5.jsp"); // Redirect to the next level
