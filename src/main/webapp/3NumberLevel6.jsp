...
<head>
    ...
    <title>3Number Game Combination Game level6</title>
    <style>
        body {
            display: flex;
...
<body>
    <div class="container">
        <h1>3Number Game - Level <span id="level-number">6</span></h1>
        <div class="game">
    ...
    <div class="victory-screen">
        <h1>Level <span id="victory-level-number">6</span> Complete!</h1>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("3NumberLevel7.jsp"); // Redirect to the next level
