...
<body>
    ...
    <div class="wrapper">
        <div class="container">
            <center><h2 style="background-color:rgb(99, 188, 230);">Gusses Word Level-8<br></h2></center>
...
word: "elephant",
hint: "what is big and gray with a trunk?"
...
word: "bee",
hint: "what is small and makes honey?"
...
word: "turtle",
hint: "what has a shell and moves slowly?"
...
word: "kitten",
hint: "what is fuzzy and says meow?"
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("KidGuessLevel9.jsp"); // Redirect to the next level
