...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <script>
        const words = [
        { word: "hatch", hint: "To come out of an egg." },
    { word: "iguana", hint: "A type of lizard." },
    { word: "jigsaw", hint: "Puzzle that you can fit together." },
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("KidWordscrambleLevel10.jsp"); // Redirect to the next level
