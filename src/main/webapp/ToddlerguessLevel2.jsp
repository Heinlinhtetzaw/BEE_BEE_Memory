...
<head>
    ...
    <title>Guess a Word Game level-2</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="victory-screen">
        <h1>Level <span id="victory-level-number">2</span> Completed!</h1>
    ...
    <div class="try-again-screen" id="try-again-screen">
        ...
        <div class="buttons">
            ...
            <div class="wrapper">
        <div class="container">
            <center><h2 style="background-color:rgb(28, 223, 70);">Gusses Word Level-2<br></h2></center>
            
            <center><div class="timer" style="background-color:rgb(28, 223, 70);">🕥 Time Left: <span id="timer">20</span> seconds<br><br></div></center>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <input type="hidden" name="gameId" value="12"> <!-- Replace with actual game ID -->
...
word: "habitat",
hint: "what do we call the place where animals live?"
...
word: "ocean",
hint: "what do we call the big blue stuff we swim in?"
...
word: "sun",
hint: "what do flowers need to grow?"
        ...
        function handleVictory() {
            ...
            document.getElementById("victory-level-number").innerText = 2;
        }
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("ToddlerguessLevel3.jsp"); // Redirect to the next level
