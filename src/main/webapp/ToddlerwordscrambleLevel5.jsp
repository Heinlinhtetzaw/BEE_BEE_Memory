...
<head>
    ...
    <title>Word Scramble Level5</title>
...
<body>
    ...
    <h4 style="font-size: 2.5em;">Word Scramble Level-5</h4>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    { word: "computer", hint: "An electronic device for processing information." },
    { word: "book", hint: "A collection of pages with writing." },
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("ToddlerwordscrambleLevel6.jsp"); // Redirect to the next level
