...
<html>
<head>
  <title>Brain Trainer Level4</title>
  <style>
    body {
...
<body>
  <div class="container">
    <h1>Brain Trainer - Level <span id="level-number">4</span></h1>
...
<%
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("BrainLevel5.jsp"); // Redirect to the next level
