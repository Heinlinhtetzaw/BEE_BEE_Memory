...
<head>
    ...
    <title>Guess a Word Game level-8</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="wrapper">
        <div class="container">
            <center><h2 style="background-color:rgb(28, 223, 70);">Gusses Word Level-8<br></h2></center>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <script>
        const wordList = [
        {
            ...
            word: "cucumber",
hint: "i’m green and you can crunch me. what am i?"
...

{
    ...
    word: "peach",
hint: "i’m sweet and i grow on trees. what am i?"
...
word: "carrot",
hint: "i’m a vegetable and rabbits love me. what am i?"
        ...
        function handleVictory() {
            ...
            document.getElementById("victory-level-number").innerText = 8;
        }
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("ToddlerguessLevel9.jsp"); // Redirect to the next level
