...
<head>
    ...
    <title>Guess a Word Game level-6</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="wrapper">
        <div class="container">
            <center><h2 style="background-color:rgb(28, 223, 70);">Gusses Word Level-6<br></h2></center>
...
word: "strawberry",
hint: "what fruit is red and juicy?"
...
word: "cucumber",
hint: "what vegetable is green and crunchy?"
...
word: "elephant",
hint: "what is biggest body in animal?"
...
hint: "What has a long tail and climbs trees?"
        ...
        function handleVictory() {
            ...
            document.getElementById("victory-level-number").innerText = 6;
        }
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("ToddlerguessLevel7.jsp"); // Redirect to the next level
