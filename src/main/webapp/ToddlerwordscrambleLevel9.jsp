...
<head>
    ...
    <title>Word Scramble Level9</title>
...
<body>
    <div class="victory-screen" id="victory-screen">
        <h1>Level <span id="victory-level-number">9</span> Completed!</h1>
    ...
    <h4 style="font-size: 2.5em;">Word Scramble Level-9</h4>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <script>
        const words = [
        { word: "mouth", hint: "Used to eat and talk." },
    { word: "hand", hint: "Used to wave and hold things." },
    { word: "finger", hint: "A small part of your hand." },
    { word: "foot", hint: "Used to walk and run." },
        ];
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("ToddlerwordscrambleLevel10.jsp"); // Redirect to the next level
