...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <script>
        const words = [
        { word: "language", hint: "System of communication used by a particular community" },
    { word: "holiday", hint: "Day of celebration or rest" },
    { word: "jewelry", hint: "Decorative items worn for personal adornment" },
