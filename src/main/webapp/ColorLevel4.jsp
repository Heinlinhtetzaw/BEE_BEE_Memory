...
<head>
    ...
    <title>Color Memory Game Lvel4</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <h2>Color Memory Game - Level <span id="level-number">4</span></h2>
        <div class="timer">🕥Time Left: <span id="timer">52</span> seconds</div>
        <div class="game"></div>
    </div>
    ...
    function startTimer() {
        let timeLeft = 52; // Fixed time for level 1
