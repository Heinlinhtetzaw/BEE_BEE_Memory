...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <script>
        const words = [
        { word: "sculpture", hint: "Three-dimensional art made from materials" },
    { word: "internet", hint: "Global network of computers" },
    { word: "exercise", hint: "Physical activity to improve health" },
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("WordscrambleLevel10.jsp"); // Redirect to the next level
