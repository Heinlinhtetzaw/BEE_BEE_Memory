...
<head>
    ...
    <title>Word Scramble Level4</title>
...
<body>
    ...
    <h4 style="font-size: 2.5em;">Word Scramble Level-4</h4>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("ToddlerwordscrambleLevel5.jsp"); // Redirect to the next level
