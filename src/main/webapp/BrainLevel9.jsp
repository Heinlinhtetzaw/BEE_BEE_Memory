...
<html>
<head>
  <title>Brain Trainer Level9</title>
  <style>
    body {
...
<body>
  <div class="container">
    <h1>Brain Trainer - Level <span id="level-number">9</span></h1>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <input type="hidden" name="score" value="21"> <!-- Track score -->
	</form>
...
<%
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("BrainLevel10.jsp"); // Redirect to the next level
