...
<body>
    ...
    <div class="wrapper">
        <div class="container">
            <center><h2 style="background-color:rgb(99, 188, 230);">Gusses Word Level-4<br></h2></center>
...
hint: "A fruit with a green skin and black seeds inside? "
...
hint: "What fruit is round and orange?"
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("KidGuessLevel5.jsp"); // Redirect to the next level
