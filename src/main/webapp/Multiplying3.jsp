...
<head>
    <meta charset="utf-8">
    <title>Multiplying Game Level 3</title>
...
<body>
    <h1 class="gametitle">Multiplying Number Game &nbsp;<span id="level">Level 3</span><br><br>You need 5 correct answers to proceed to the next level.</h1>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <script>
        ...
        var maxScore = 5;  // Correct answers required to complete the level
        ...
        function setTimeForLevel(level) {
            timeRemaining = 20;  // Fixed time for level 1
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("Multiplying4.jsp"); // Redirect to the next level
