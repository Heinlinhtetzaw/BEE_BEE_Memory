...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    { word: "sound", hint: "Vibration that travels through air" },
    { word: "bread", hint: "Common staple food made from flour" },
    { word: "fruit", hint: "Edible product of a plant" },
        ];
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("WordscrambleLevel4.jsp"); // Redirect to the next level
