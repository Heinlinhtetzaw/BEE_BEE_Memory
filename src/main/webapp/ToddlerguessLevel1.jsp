...
<head>
    ...
    <title>Guess a Word Game level-1</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="try-again-screen" id="try-again-screen">
        ...
        <div class="buttons">
            ...
            <div class="wrapper">
        <div class="container">
            <center><h2 style="background-color:rgb(28, 223, 70);">Gusses Word Level-1<br></h2></center>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <script>
        const wordList = [
            {  
            word: "oxygen",
            hint: "what do trees give us?"},
            { word: "green",
            hint: "what color are most leaves?"},
            { word: "water",
            hint: "where do fish live?" },
            {  word: "honey",
            hint: "what do bees make?"},
        ...
        function handleVictory() {
            ...
            document.getElementById("victory-level-number").innerText = 1;
        }
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("ToddlerguessLevel2.jsp"); // Redirect to the next level
