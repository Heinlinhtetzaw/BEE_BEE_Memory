...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <script>
        const words = [
        { word: "computer", hint: "Device for processing information" },
    { word: "safety", hint: "Condition of being protected" },
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("WordscrambleLevel9.jsp"); // Redirect to the next level
