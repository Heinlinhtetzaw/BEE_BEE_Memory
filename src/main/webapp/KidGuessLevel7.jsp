...
<body>
    ...
    <div class="wrapper">
        <div class="container">
            <center><h2 style="background-color:rgb(99, 188, 230);">Gusses Word Level-7<br></h2></center>
...
word: "frog",
hint: "what lives in water and says ribbit?"
...
word: "butterfly",
hint: "what flies and has colorful wings?",
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("KidGuessLevel8.jsp"); // Redirect to the next level
