...
<body>
    ...
    <div class="victory-screen">
        ...
        <div class="score">Score: <span id="score">3</span></div>
        <div class="buttons">
    ...
    <div class="wrapper">
        <div class="container">
            <center><h2 style="background-color:rgba(206, 41, 228);">Gusses Word Level-2<br></h2></center>
            
            <center><div class="timer" style="background-color:rgba(206, 41, 228);">🕥 Time Left: <span id="timer">20</span> seconds<br><br></div></center>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <input type="hidden" name="gameId" value="8"> <!-- Replace with actual game ID -->
...
hint: "land surrounded by water"
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("guessesLevel10.jsp"); // Redirect to the next level
