...
<body>
    ...
    <div class="try-again-screen" id="try-again-screen">
        ...
        <div class="buttons">
            ...
            <div class="wrapper">
        <div class="container">
            <center><h2 style="background-color:rgb(99, 188, 230);">Gusses Word Level-2<br></h2></center>
...
hint: "What color are blueberries?"
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("KidGuessLevel3.jsp"); // Redirect to the next level
