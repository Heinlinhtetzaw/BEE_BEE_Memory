...
<head>
    <meta charset="utf-8">
    <title>Multiplying Game Level 6</title>
...
<body>
    <h1 class="gametitle">Multiplying Number Game &nbsp;<span id="level">Level 6</span><br><br>You need 8 correct answers to proceed to the next level.</h1>

    <!-- Victory Screen -->
    <div class="victory-screen">
        <h1>Level 6  Completed!</h1>
        <br>
        <div class="score">Score : 13</div>
        <div class="buttons">
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <input type="hidden" name="score" value="8"> <!-- Track score -->
	</form>
    <script>
        var playing = false;
        var timeRemaining;
        ...
        var maxScore = 8;  // Correct answers required to complete the level
        ...
        function setTimeForLevel(level) {
            timeRemaining = 32;  // Fixed time for level 1
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("Multiplying7.jsp"); // Redirect to the next level
