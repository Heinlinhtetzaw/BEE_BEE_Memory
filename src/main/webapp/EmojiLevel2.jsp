...
<head>
    ...
    <title>Emoji Game level 2</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <h2>Emoji Game - Level <span id="level-number">2</span></h2>
        <div class="timer">🕥 Time Left: <span id="timer">24</span> seconds</div>
        <div class="game"></div>
    </div>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <input type="hidden" name="gameId" value="3"> <!-- Replace with actual game ID -->
    ...
    <script>
        ...
        function startGame() {
            ...
            gameCompleted = false;
            const numberOfCards = 8;// Fixed number of cards
        ...
        function startTimer() {
            let timeLeft = 24; // Fixed time for the game
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("EmojiLevel3.jsp"); // Redirect to the next level
