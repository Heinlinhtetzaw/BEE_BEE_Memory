...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <script>
        const words = [
        { word: "apple", hint: "A round fruit that is red or green." },
    { word: "banana", hint: "A long yellow fruit that monkeys love." },
    { word: "balloon", hint: "A colorful object that can float." },
    { word: "candy", hint: "Sweet treat that kids enjoy." },
        ];
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("KidWordscrambleLevel2.jsp"); // Redirect to the next level
