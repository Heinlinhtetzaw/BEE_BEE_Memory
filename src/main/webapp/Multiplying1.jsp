...
<head>
    <meta charset="utf-8">
    <title>Multiplying Game Level 1</title>
...
<body>
    <h1 class="gametitle">Multiplying Number Game &nbsp;<span id="level">Level 1</span><br><br>You need 3 correct answers to proceed to the next level.</h1>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <script>
        ...
        var maxScore = 3;  // Correct answers required to complete the level
        ...
        function setTimeForLevel(level) {
            timeRemaining = 12;  // Fixed time for level 1
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("Multiplying2.jsp"); // Redirect to the next level
