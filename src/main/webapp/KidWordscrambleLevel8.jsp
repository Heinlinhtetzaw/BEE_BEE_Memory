    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            background: linear-gradient(135deg, #ec6f26, #00c6ff, #d15454);
            color: #333;
            display: flex;
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <input type="hidden" name="gameId" value="11"> <!-- Replace with actual game ID -->
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("KidWordscrambleLevel9.jsp"); // Redirect to the next level
