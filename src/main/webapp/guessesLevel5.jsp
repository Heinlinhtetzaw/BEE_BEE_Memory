...
<body>
    ...
    <div class="victory-screen">
        <h1>Level <span id="victory-level-number">5</span> Completed!</h1>
    ...
    <div class="wrapper">
        <div class="container">
            <center><h2 style="background-color:rgba(206, 41, 228);">Gusses Word Level-5<br></h2></center>
...
hint: "a famous city of waters"
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("guessesLevel6.jsp"); // Redirect to the next level
