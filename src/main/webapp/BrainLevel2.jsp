...
<html>
<head>
  <title>Brain Trainer Level2</title>
  <style>
    body {
...
<body>
  <div class="container">
    <h1>Brain Trainer - Level <span id="level-number">2</span></h1>
  ...
  <%
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("BrainLevel3.jsp"); // Redirect to the next level
