...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <script>
        const words = [
        { word: "dinosaur", hint: "Huge reptiles that lived long ago." },
    { word: "elephant", hint: "The largest land animal with a trunk." },
    { word: "fairy", hint: "A magical creature with wings." },
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("KidWordscrambleLevel3.jsp"); // Redirect to the next level
