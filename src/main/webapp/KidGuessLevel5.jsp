...
<body>
    ...
    <div class="wrapper">
        <div class="container">
            <center><h2 style="background-color:rgb(99, 188, 230);">Gusses Word Level-5<br></h2></center>
...
hint: "What is green fruit with the most nutrients? "
...
hint: "What fruit has seeds and red on the outside?  "
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("KidGuessLevel6.jsp"); // Redirect to the next level
