...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <script>
        const words = [
        { word: "turtle", hint: "A slow-moving animal with a shell." },
    { word: "unicorn", hint: "Mythical horse with a single horn." },
    { word: "vampire", hint: "Fictional creature that drinks blood." },
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("KidWordscrambleLevel7.jsp"); // Redirect to the next level
