...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    { word: "dream", hint: "Thoughts and images during sleep" },
    { word: "phone", hint: "Device used for communication" },
    { word: "photo", hint: "Image created by light on a surface" },
        ];
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("WordscrambleLevel6.jsp"); // Redirect to the next level
