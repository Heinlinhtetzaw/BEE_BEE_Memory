...
<head>
    ...
    <title>Word Scramble Level2</title>
    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            background: linear-gradient(135deg, #d526ec,#2633ec, #46cf24, #d526ec);
            color: #333;
            display: flex;
        ...
        .container {
            background: linear-gradient(135deg, #22f0f7,#4fd33e,#b8d33e);
            border-radius: 20px;
...
<body>
    ...
    <h4 style="font-size: 2.5em;">Word Scramble Level-2</h4>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <input type="hidden" name="gameId" value="13"> <!-- Replace with actual game ID -->
    <input type="hidden" name="completedLevel" value="1"> <!-- Track level completion -->
    <input type="hidden" name="score" value="3"> <!-- Track score -->
	</form>
    <script>
        const words = [
        { word: "fabric", hint: "Material made from fibers, used for clothing." },
    { word: "paper", hint: "A thin material made from wood pulp." },
    { word: "rubber", hint: "A flexible material used in tires." },
    { word: "ceramic", hint: "A hard material made from clay, often used for dishes." },
        ];
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("ToddlerwordscrambleLevel3.jsp"); // Redirect to the next level
