...
<head>
    ...
    <title>Emoji Game level 1</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <h2>Emoji Game - Level <span id="level-number">1</span></h2>
        <div class="timer">🕥 Time Left: <span id="timer">12</span> seconds</div>
        <div class="game"></div>
    </div>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <input type="hidden" name="score" value="5"> <!-- Track score -->
	</form>
    <script>
        const emojis = [
            "&#128507;", "&#128508;", "&#128511;", "&#128512;",
        ...
        function startGame() {
            ...
            gameCompleted = false;
            const numberOfCards = 4; // Fixed number of cards
        ...
        function startTimer() {
            let timeLeft = 12; // Fixed time for the game
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("EmojiLevel2.jsp"); // Redirect to the next level
