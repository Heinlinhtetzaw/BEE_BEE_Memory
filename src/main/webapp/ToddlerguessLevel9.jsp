...
<head>
    ...
    <title>Guess a Word Game level-9</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="wrapper">
        <div class="container">
            <center><h2 style="background-color:rgb(28, 223, 70);">Gusses Word Level-9<br></h2></center>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <script>
        const wordList = [
        {
            ...
            word: "grape",
hint: "i’m small, round, and can be purple or green. what am i?"
...

{
    ...
    word: "strawberry",
hint: "i’m a fruit with seeds on the outside. what am i?"
...

{
    ...
    word: "lettuce",
hint: "i’m a leafy vegetable, often used in salads. what am i?"
        ...
        function handleVictory() {
            ...
            document.getElementById("victory-level-number").innerText = 9;
        }
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("ToddlerguessLevel10.jsp"); // Redirect to the next level
