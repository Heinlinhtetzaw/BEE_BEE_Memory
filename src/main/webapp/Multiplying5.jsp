...
<head>
    <meta charset="utf-8">
    <title>Multiplying Game Level 5</title>
...
<body>
    <h1 class="gametitle">Multiplying Number Game &nbsp;<span id="level">Level 5</span><br><br>You need 7 correct answers to proceed to the next level.</h1>

    <!-- Victory Screen -->
    <div class="victory-screen">
        <h1>Level 5  Completed!</h1>
        <br>
        <div class="score">Score : 11</div>
        <div class="buttons">
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <script>
        ...
        var maxScore = 7;  // Correct answers required to complete the level
        ...
        function setTimeForLevel(level) {
            timeRemaining = 28;  // Fixed time for level 1
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("Multiplying6.jsp"); // Redirect to the next level
