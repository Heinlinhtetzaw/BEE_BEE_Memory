...
<head>
    ...
    <title>Word Scramble Level1</title>
...
<body>
    ...
    <h4 style="font-size: 2.5em;">Word Scramble Level-1</h4>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <script>
        const words = [
        { word: "wood", hint: "Material from trees used for building." },
    { word: "plastic", hint: "A synthetic material used in many products." },
    { word: "metal", hint: "A solid material that is hard and shiny." },
    { word: "glass", hint: "A transparent material used for windows." },
        ];
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("ToddlerwordscrambleLevel2.jsp"); // Redirect to the next level
