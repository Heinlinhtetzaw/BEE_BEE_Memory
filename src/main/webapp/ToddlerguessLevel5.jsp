...
<head>
    ...
    <title>Guess a Word Game level-5</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="wrapper">
        <div class="container">
            <center><h2 style="background-color:rgb(28, 223, 70);">Gusses Word Level-5<br></h2></center>
...
word: "bookshelf",
hint: "what has shelves for books?"
...
word: "ottoman",
hint: "what do we use to put our feet up?"
...
word: "chair",
hint: "what do we sit on outside?"
        ...
        function handleVictory() {
            ...
            document.getElementById("victory-level-number").innerText = 5;
        }
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("ToddlerguessLevel6.jsp"); // Redirect to the next level
