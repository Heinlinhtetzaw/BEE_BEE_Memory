...
<head>
    ...
    <title>Math Addition Quiz Game - Level 7</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>Math Addition Quiz Game - Level 7</h1>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("MathLevel8.jsp"); // Redirect to the next level
