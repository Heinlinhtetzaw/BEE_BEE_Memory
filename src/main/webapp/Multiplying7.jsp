...
<head>
    <meta charset="utf-8">
    <title>Multiplying Game Level 7</title>
...
<body>
    <h1 class="gametitle">Multiplying Number Game &nbsp;<span id="level">Level 7</span><br><br>You need 9 correct answers to proceed to the next level.</h1>

    <!-- Victory Screen -->
    <div class="victory-screen">
        <h1>Level 7  Completed!</h1>
        <br>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <script>
        ...
        var maxScore = 9;  // Correct answers required to complete the level
        ...
        function setTimeForLevel(level) {
            timeRemaining = 36;  // Fixed time for level 1
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("Multiplying8.jsp"); // Redirect to the next level
