...
<head>
    ...
    <title>Word Scramble Level3</title>
...
<body>
    <div class="victory-screen" id="victory-screen">
        <h1>Level <span id="victory-level-number">3</span> Completed!</h1>
    ...
    <h4 style="font-size: 2.5em;">Word Scramble Level-3</h4>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    { word: "dolphin", hint: "A smart sea creature that jumps out of water." },
    { word: "kangaroo", hint: "A jumping animal from Australia with a pouch." },
    { word: "panda", hint: "A black and white bear that loves bamboo." },
        ];
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("ToddlerwordscrambleLevel4.jsp"); // Redirect to the next level
