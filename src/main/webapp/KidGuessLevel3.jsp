...
<body>
    ...
    <div class="wrapper">
        <div class="container">
            <center><h2 style="background-color:rgb(99, 188, 230);">Gusses Word Level-3<br></h2></center>
...
hint: "What color is a stop sign? "
...
hint: "What color is a giraffe's spots?"
...
hint: "What fruit is yellow?  "
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("KidGuessLevel4.jsp"); // Redirect to the next level
