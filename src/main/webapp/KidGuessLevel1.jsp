...
<body>
    ...
    <div class="try-again-screen" id="try-again-screen">
        ...
        <div class="buttons">
            ...
            <div class="wrapper">
        <div class="container">
            <center><h2 style="background-color:rgb(99, 188, 230);">Gusses Word Level-1<br></h2></center>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <script>
        const wordList = [
            { word: "yellow", 
            hint: "What color is the sun?" },
            { word: "blue", hint: "What color is the sky?" },
            { word: "green", hint: "What color is grass?" },
            { word: "red", hint: "What color are strawberries?" },
        ];
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("KidGuessLevel2.jsp"); // Redirect to the next level
