...
<head>
    ...
    <title>Guess a Word Game level-3</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="wrapper">
        <div class="container">
            <center><h2 style="background-color:rgb(28, 223, 70);">Gusses Word Level-3<br></h2></center>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <script>
        const wordList = [
        {
            ...
            word: "air",
hint: "what do we call the air we breathe?"
...
hint: "what do we sleep on?"
        ...
        function handleVictory() {
            ...
            document.getElementById("victory-level-number").innerText = 3;
        }
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("ToddlerguessLevel4.jsp"); // Redirect to the next level
