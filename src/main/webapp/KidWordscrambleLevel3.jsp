...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    { word: "igloo", hint: "A house made of ice, usually found in cold places." },
    { word: "jelly", hint: "A sweet spread made from fruit." },
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("KidWordscrambleLevel4.jsp"); // Redirect to the next level
