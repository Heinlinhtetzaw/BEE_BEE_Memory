...
<head>
    ...
    <title>Word Scramble Level8</title>
...
<body>
    <div class="victory-screen" id="victory-screen">
        <h1>Level <span id="victory-level-number">8</span> Completed!</h1>
    ...
    <h4 style="font-size: 2.5em;">Word Scramble Level-8</h4>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <script>
        const words = [
        { word: "dragon", hint: "Mythical creature that can breathe fire." },
    { word: "elephant", hint: "Large animal with big ears and a trunk." },
    { word: "firetruck", hint: "Vehicle used by firefighters." },
 ...
 <%
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("ToddlerwordscrambleLevel9.jsp"); // Redirect to the next level
