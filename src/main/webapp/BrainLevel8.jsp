...
<html>
<head>
  <title>Brain Trainer Level8</title>
  <style>
    body {
...
<body>
  <div class="container">
    <h1>Brain Trainer - Level <span id="level-number">8</span></h1>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <input type="hidden" name="score" value="19"> <!-- Track score -->
	</form>
  <script>
...
<%
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("BrainLevel9.jsp"); // Redirect to the next level
