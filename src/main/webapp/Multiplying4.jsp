...
<head>
    <meta charset="utf-8">
    <title>Multiplying Game Level 4</title>
...
<body>
    <h1 class="gametitle">Multiplying Number Game &nbsp;<span id="level">Level 4</span><br><br>You need 6 correct answers to proceed to the next level.</h1>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <input type="hidden" name="score" value="6"> <!-- Track score -->
	</form>
    <script>
        var playing = false;
        var timeRemaining;
        ...
        var maxScore = 6;  // Correct answers required to complete the level
        ...
        function setTimeForLevel(level) {
            timeRemaining = 24;  // Fixed time for level 1
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("Multiplying5.jsp"); // Redirect to the next level
