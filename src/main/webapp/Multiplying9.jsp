...
<head>
    <meta charset="utf-8">
    <title>Multiplying Game Level 9</title>
...
<body>
    <h1 class="gametitle">Multiplying Number Game &nbsp;<span id="level">Level 9</span><br><br>You need 11 correct answers to proceed to the next level.</h1>

    <!-- Victory Screen -->
    <div class="victory-screen">
        <h1>Level 9  Completed!</h1>
        <br>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <input type="hidden" name="score" value="11"> <!-- Track score -->
	</form>
    <script>
        var playing = false;
        var timeRemaining;
        ...
        var maxScore = 11;  // Correct answers required to complete the level
        ...
        function setTimeForLevel(level) {
            timeRemaining = 44;  // Fixed time for level 1
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("Multiplying10.jsp"); // Redirect to the next level
