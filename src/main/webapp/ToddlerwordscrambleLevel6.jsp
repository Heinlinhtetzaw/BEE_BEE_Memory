...
<head>
    ...
    <title>Word Scramble Level6</title>
...
<body>
    <div class="victory-screen" id="victory-screen">
        <h1>Level <span id="victory-level-number">6</span> Completed!</h1>
    ...
    <h4 style="font-size: 2.5em;">Word Scramble Level-6</h4>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <script>
        const words = [
        { word: "umbrella", hint: "A tool used for protection against rain." },
    { word: "backpack", hint: "A bag carried on the back." },
    { word: "chair", hint: "A piece of furniture for sitting." },
    { word: "table", hint: "A flat surface supported by legs." },
        ];
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("ToddlerwordscrambleLevel7.jsp"); // Redirect to the next level
