...
<head>
    ...
    <title>Color Memory Game Level1</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="timer">🕥Time Left: <span id="timer">13</span> seconds</div>
        <div class="game"></div>
    </div>
    ...
    function startTimer() {
        let timeLeft = 13; // Fixed time for level 1
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("ColorLevel2.jsp"); // Redirect to the next level
