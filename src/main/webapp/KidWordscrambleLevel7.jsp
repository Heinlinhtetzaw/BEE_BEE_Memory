...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    { word: "yoyo", hint: "Toy that goes up and down on a string." },
    { word: "zebra", hint: "Horse-like animal with black and white stripes." },
    { word: "castle", hint: "Large building often associated with royalty." },
        ];
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("KidWordscrambleLevel8.jsp"); // Redirect to the next level
