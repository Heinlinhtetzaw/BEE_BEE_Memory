...
<head>
    ...
    <title>3Number Game Combination Game level4</title>
    <style>
        body {
            display: flex;
...
<body>
    <div class="container">
        <h1>3Number Game - Level <span id="level-number">4</span></h1>
        <div class="game">
    ...
    <div class="victory-screen">
        <h1>Level <span id="victory-level-number">4</span> Complete!</h1>
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("3NumberLevel5.jsp"); // Redirect to the next level
