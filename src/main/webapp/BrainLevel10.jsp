...
<html>
<head>
  <title>Brain Trainer Level10</title>
  <style>
    body {
...
<body>
  <div class="container">
    <h1>Brain Trainer - Level <span id="level-number">10</span></h1>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <input type="hidden" name="score" value="23"> <!-- Track score -->
	</form>
  <script>
