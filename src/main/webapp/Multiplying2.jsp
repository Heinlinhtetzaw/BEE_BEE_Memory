...
<head>
    <meta charset="utf-8">
    <title>Multiplying Game Level 2</title>
...
<body>
    <h1 class="gametitle">Multiplying Number Game &nbsp;<span id="level">Level 2</span><br><br>You need 4 correct answers to proceed to the next level.</h1>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <input type="hidden" name="score" value="4"> <!-- Track score -->
	</form>
    <script>
        var playing = false;
        var timeRemaining;
        ...
        var maxScore = 4;  // Correct answers required to complete the level
        ...
        function setTimeForLevel(level) {
            timeRemaining = 16;  // Fixed time for level 1
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("Multiplying3.jsp"); // Redirect to the next level
