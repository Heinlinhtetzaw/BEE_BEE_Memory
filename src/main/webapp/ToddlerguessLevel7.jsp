...
<head>
    ...
    <title>Guess a Word Game level-7</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="wrapper">
        <div class="container">
            <center><h2 style="background-color:rgb(28, 223, 70);">Gusses Word Level-7<br></h2></center>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <script>
        const wordList = [
        {
            ...
            word: "market",
hint: "i’m a place to buy food. what am i?"
...
word: "tomato",
hint: "i’m round and red, and i’m often used in salads. what am i?"
...
word: "banana",
hint: "i’m yellow and can be peeled. what am i?"
        ...
        function handleVictory() {
            ...
            document.getElementById("victory-level-number").innerText = 7;
        }
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("ToddlerguessLevel8.jsp"); // Redirect to the next level
