...
<body>
    ...
    <div class="wrapper">
        <div class="container">
            <center><h2 style="background-color:rgb(99, 188, 230);">Gusses Word Level-6<br></h2></center>
...
hint: "What fruit with a single seed?  "
...
hint: "What has four legs and barks?"
...
hint: "What has a long tail and climbs trees?"
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("KidGuessLevel7.jsp"); // Redirect to the next level
