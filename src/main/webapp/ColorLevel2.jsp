...
<head>
    ...
    <title>Color Memory Game Lvel2</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <h2>Color Memory Game - Level <span id="level-number">2</span></h2>
        <div class="timer">🕥Time Left: <span id="timer">26</span> seconds</div>
        <div class="game"></div>
    </div>
    ...
    <input type="hidden" name="gameId" value="1"> <!-- Replace with actual game ID -->
    <input type="hidden" name="completedLevel" value="1"> <!-- Track level completion -->
    <input type="hidden" name="score" value="7"> <!-- Track score -->
	</form>
    ...
    function startGame() {
        ...
        // Set fixed number of cards for level 1
    ...
    function startTimer() {
        let timeLeft = 26; // Fixed time for level 1
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("ColorLevel3.jsp"); // Redirect to the next level
