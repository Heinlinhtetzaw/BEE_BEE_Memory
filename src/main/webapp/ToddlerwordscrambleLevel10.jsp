...
<head>
    ...
    <title>Word Scramble Level10</title>
...
<body>
    ...
    <h4 style="font-size: 2.5em;">Word Scramble Level-10</h4>
...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <script>
        const words = [
        { word: "leg", hint: "Helps you jump and play." },
    { word: "belly", hint: "The round part in the middle." },
    { word: "arm", hint: "Used to hug and lift." },
    { word: "toes", hint: "Small parts at the end of your foot." },
        ];
