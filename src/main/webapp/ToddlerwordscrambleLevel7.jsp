...
<!-- Hidden Form for Submitting Game Progress -->
    ...
    <script>
        const words = [
        { word: "head", hint: "The top part of your body." },
    { word: "eye", hint: "Used to see the world." },
    { word: "ear", hint: "Used to hear sounds." },
    { word: "nose", hint: "Used to smell flowers." },
        ];
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            response.sendRedirect("ToddlerwordscrambleLevel8.jsp"); // Redirect to the next level
